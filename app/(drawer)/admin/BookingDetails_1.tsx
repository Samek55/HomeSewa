...
<style>
  ...
  .lbl{font-size:11px;color:#888;font-weight:bold;text-transform:uppercase;margin-bottom:2px;margin-top:12px}
...
<div class="lbl">Customer</div><div class="val">${booking.fullName}</div>
<div class="lbl">Phone</div><div class="val">+977 ${booking.phone}</div>
<div class="lbl">Service</div><div class="val">${booking.service}</div>
<div class="lbl">Budget</div><div class="val">${booking.budget}</div>
<div class="lbl">Location</div><div class="val">${location}</div>
<div class="lbl">Booking Date</div><div class="val">${booking.bookingDate}</div>
<div class="lbl">Starting Date</div><div class="val">${booking.startingDate}</div>
${booking.completionDate ? `<div class="lbl">Ending Date</div><div class="val">${booking.completionDate}</div>` : ''}
${booking.approxDays != null ? `<div class="lbl">Approx Days to Complete</div><div class="val">${booking.approxDays} Day${booking.approxDays !== 1 ? 's' : ''}</div>` : ''}
